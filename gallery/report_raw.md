...
Выполнил: Ахметов Раиль Рамилович
Группа: 0907-35
...
Каждый коммит создавался командой `git add <file>` и `git commit -m "описание"`. После завершения всех работ репозиторий опубликован на GitHub: https://github.com/grop18529-rgb/flappy-bird
